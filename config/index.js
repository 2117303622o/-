export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  // APP_ID: "wx340812a155e8e11b",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  // APP_SECRET: "d50706e485dfbee9e167758c855ed5db",
   ...
   *    // 你想对他发送的模板消息的模板ID
   *    useTemplateId: "ozTDL57nrjPQgXfTfnjN62OxBqi4",
   *    // 他点击详情后跳转的页面,你可以设置成微博的热榜，也可以设置成其他，网址一定要填对；不填对也没关系，随便你，会打不开而已。
   *    openUrl: "https://wangxinleo.cn"
   *   }, 
   * ]
   */
  USERS: [ozTDL57nrjPQgXfTfnjN62OxBqi4
    {
      // 想要发送的人的名字
      name: "小树",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
  ...
  CALLBACK_USERS: [ozTDL57nrjPQgXfTfnjN62OxBqi4	
    {
      // 一般都填自己
      name: "自己",
   ...
   */
  FESTIVALS: [
    {"type": "生日", "name": "老婆", "year": "2003", "date": "09-17"},
    {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "08-01"},
    {"type": "生日", "name": "老公", "year": "2003", "date": "01-8"},
